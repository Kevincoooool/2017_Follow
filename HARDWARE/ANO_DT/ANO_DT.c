...
void ANO_DT_Send_Data(u8 *dataToSend , u8 length)
{
	...
	while(length>0){
		USART_SendData(USART1,(u8)*dataToSend);
		dataToSend++;
		length--;
...
//		if(*(data_buf+3)==20)
//  	{
//		remoteControl[1] = (vu16)(*(data_buf+4)<<8)|*(data_buf+5);
//   remoteControl[0] = (vu16)(*(data_buf+6)<<8)|*(data_buf+7);
//   remoteControl[3] = (vu16)(*(data_buf+8)<<8)|*(data_buf+9);
//   remoteControl[2]= (vu16)(*(data_buf+10)<<8)|*(data_buf+11);
